...
<h1 class="page-title">Graduate Research</h1>

<!-- Your existing HTML code -->
<h2 class="role"><span>AirLab</span><span class="role__meta">Carnegie Mellon University</span></h2>
<div class="item">
  <div class="item__image">
    <div class="card"> <!-- Adjust the width as needed -->
      <div class="card image--md">
        <div class="card__image">
          <img class="image" src="/assets/images/research/drone.png">
        </div>
      </div>
    </div>
  </div>
  <div class="item__content">
    <h3 class="role"><span>Time-Optimal Path Planning for UAVs in Uniform Wind</span><span class="role__meta">2022 - 2023</span></h3>
...
<h2 class="role"><span>Biorobotics Lab</span><span class="role__meta">Carnegie Mellon University</span></h2>
<div class="item">
  <div class="item__image">
    <div class="card"> <!-- Adjust the width as needed -->
      <div class="card image--md">
  ...
  <div class="item__content">
    <h3 class="role"><span>Electronic Waste Disassembly - Fastener Disassembly</span><span class="role__meta">2021 - 2022</span></h3>
    <div class="item__description">
      <ul style="font-size:16px">
...
<h1 class="page-title">Undergraduate Research</h1>

<h2 class="role"><span>Engineering System Design Lab</span><span class="role__meta">University of Illinois at Urbana-Champaign (UIUC)</span></h2>
<div class="item">
  <div class="item__image">
  ...
  <div class="item__content">
        <h3 class="role"><span>ATLANTIS-ARPA-E FLOATVAWT and WEIS Projects</span><span class="role__meta">2020 - 2021</span></h3>
    <div class="item__description">
      <ul style="font-size:16px">
...
<h2 class="role"><span>Energy Transport Research Lab (ETRL)</span><span class="role__meta">University of Illinois at Urbana-Champaign (UIUC)</span></h2>
<div class="item">
  <div class="item__image">
    <div class="card">
      <div class="card image--md">
  ...
  <div class="item__content">
        <h3 class="role"><span>Radiative Cooling Project</span><span class="role__meta">2019 - 2020</span></h3>
    <div class="item__description">
       <ul style="font-size:16px">
